    ...
    return (
        <header className="p-3 w-full fixed top-0 z-50 bg-linear-to-r from-primary to-black">
            <div className="flex align-middle items-center px-10 mx-auto gap-6 cursor-pointer">
                <a className="max-h-16 text-white flex items-center gap-3
             border-r-white boarder-r-2 pr-6">
                    <h3 className="text-2xl font-semibold text-white uppercase">Ying-Ying</h3>
                </a>
